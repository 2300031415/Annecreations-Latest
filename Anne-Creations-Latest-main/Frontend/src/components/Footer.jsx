...
const Footer = () => {
  ...
  return (
    <footer className="w-full overflow-hidden mt-20 font-[600] text-white">
      {/* Top Section */}
      <div className="bg-[var(--product-card-bg)] py-10 px-4">
        <Container>
          <div className="flex w-full flex-col lg:flex-row flex-wrap justify-between text-white">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="relative group">
                  <a
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-[var(--card-bg)] rounded-lg text-[var(--secondary)]"
                  >
      ...
      {/* Bottom Bar */}
      <div className="bg-[var(--product-card-bg)] py-4">
        <Container>
