        ...
        <ul className="flex flex-col gap-2 sm:gap-3 w-full">
          ...
          <li className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full mt-2">
            <button
              ...
              className="rounded-lg px-4 sm:px-5 py-2 cursor-pointer font-semibold border-[var(--secondary)] border-2 text-[var(--secondary)] bg-white hover:bg-[var(--secondary)] hover:text-white text-md w-full sm:w-auto transition-colors"
            >
              View Details
            </button>
            <button
