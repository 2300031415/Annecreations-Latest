              ...
              <div className="flex flex-col-reverse mt-2 md:flex-row justify-around gap-1 md:gap-4">
                <div className="w-full md:w-1/2">
                  <button
                    ...
                    className="cursor-pointer font-semibold flex items-center justify-center gap-2 border-2 border-[var(--secondary)] bg-white text-[var(--secondary)] px-4 py-2 rounded-md transition hover:bg-[var(--secondary)] hover:text-white"
                  >
                    <FaRegHeart />
                ...
                <div className="w-full md:w-1/2">
                  <button
                    ...
                    className="cursor-pointer font-semibold flex items-center justify-center gap-2 px-4 py-2 rounded-md transition border-2 border-[var(--secondary)] bg-white text-[var(--secondary)] hover:bg-[var(--secondary)] hover:text-white"
                  >
